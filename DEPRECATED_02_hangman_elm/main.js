...
var $author$project$Main$update = F2(
	function (msg, model) {
		var _v0 = _Utils_Tuple2(msg, model.gameStatus);
		if (_v0.a.$ === 'NewGame') {
			var _v1 = _v0.a;
			return $author$project$Main$init($author$project$Main$defaultOptions);
		} else {
			switch (_v0.b.$) {
				case 'Playing':
					var letter = _v0.a.a;
...
var $author$project$Main$GuessLetter = function (a) {
	return {$: 'GuessLetter', a: a};
};
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Main$GuessLetter(letter)),
	...
	switch (_v0.$) {
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('😞 Game Over! The word was: ' + model.wordToGuess)
					]));
	}
};
...
var $author$project$Main$viewWord = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(displayWord)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Hangman')
					])),
				$author$project$Main$viewGameStatus(model),
				$author$project$Main$viewWord(model),
				$author$project$Main$viewLivesRemaining(model),
				$author$project$Main$viewAlphabet(model),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{
		init: $author$project$Main$init($author$project$Main$defaultOptions),
